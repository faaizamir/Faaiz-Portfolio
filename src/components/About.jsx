...
const About = () => {
  return (
    <div className="pt-12 md:py-12 px-2 sm:px-5 md:px-10 lg:px-14">
      <h2 className="after-effect after:left-52 text-white text-5xl font-medium">About Me</h2>
      ...
      <div className="pb-12 px-2 sm:px-5 md:px-10 lg:px-14">
        ...
        <div className="grid gap-8 grid-cols-1 md:grid-cols-2 xl:grid-cols-2">
          <div className="about-box dark:bg-transparent" style={{ background: 'transparent' }}>
            <img className="w-10 h-10 object-contain block" src={Icon1} alt="" />
          ...
          <div className="about-box dark:bg-transparent" style={{ background: 'transparent' }}>
            <img className="w-10 h-10 object-contain block" src={Icon6} alt="" />
            <div className="space-y-2 break-all">
